...
// Scene data classes
// =====================
export class AdminMenuMailingPreformedSceneEntranceDto implements SceneEntrance.Dto {
    readonly sceneName = 'adminMenuMailingPreformed'
}
type SceneEnterDataType = AdminMenuMailingPreformedSceneEntranceDto
type ISceneData = {
    state: SceneState
}
...
export class AdminMenuMailingPreformedScene extends Scene<ISceneData, SceneEnterDataType> {
    // =====================
    // Properties
    // =====================
