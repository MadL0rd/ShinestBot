...
// Scene data classes
// =====================
export class SurveyQuestionOptionsInlineSceneEntranceDto implements SceneEntrance.Dto {
...
type SceneEnterDataType = SurveyQuestionOptionsInlineSceneEntranceDto
type ISceneData = {
    readonly providerType: SurveyContextProviderType.Union
    readonly question: Survey.QuestionAnswerOptionInline
...
export class SurveyQuestionOptionsInlineScene extends Scene<ISceneData, SceneEnterDataType> {
    // =====================
    // Properties
    // =====================
